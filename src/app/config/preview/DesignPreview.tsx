...
const DesignPreview = ({ Configuration }: { Configuration: Configuration }) => {
  ...
  const { mutate: checkOut, isPending } = useMutation({
    ...
    onError: () => {
      toast({
        ...
        description: "There an error on our side, Please try again later.",
        variant: "destructive",
      });
    },
  });
  ...
  const handleCheckout = () => {
    if (user) {
      ...
      checkOut({ configId: Configuration.id });
    } else {
      // set configuration at local storaPscge
          ...
          <div className="grid grid-cols-1 gap-y-8 border-b border-gray-200 py-8 sm:grid-cols-2 sm:gap-x-6 sm:py-6 md:py-10">
            <div>
              ...
              <ol className="mt-3 text-zinc-700  list-disc list-inside">
                ...
                <li>TPU stock absorption</li>
                <li>Packaging made from recycled materials</li>
                <li>1 year print warrenty</li>
              </ol>
            </div>
            <div>
              <p className="font-medium text-zinc-950">Materials</p>
              <ol className="mt-3 text-zinc-700 list-disc list-inside">
                <li>High-quality, duarble materials</li>
